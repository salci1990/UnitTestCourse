...
public class TariffElectricityMeterTest {
    ...
    public void setUp(){
        ...
        electricityMeter.setElictricityTariffStartHour(12);
        electricityMeter.setElictricityTariffEndHour(14);
    }

    @Test
    public void givenOnTariffWhenKwhAddThenCounterTariffIsIncreased(){
        //Given
    ...
    @Test
    public void givenNotOnTariffWhenKwhAddThenCounterIsIncreased(){
        //Given
        Mockito.when(tp.isTariffNow()).thenReturn(false);
        //When
        electricityMeter.addKwh(100);
        //Then
        Assert.assertEquals(102, electricityMeter.getKwh(), 0.01);
    }
}
